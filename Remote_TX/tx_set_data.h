...
void joysticksSetData() {
  ...
  Serial.print(packageData.structure.j1x);Serial.print(" : ");
  Serial.print(packageData.structure.j1y);Serial.print(" : ");
  Serial.print(packageData.structure.j2x);Serial.print(" : ");
  Serial.print(packageData.structure.j2y);Serial.print(" : ");
  Serial.println("");
